...
#define IMPLEMENT_FILESYSTEM
#define IMPLEMENT_FULL_HOSTNAMERESOLVE
...
//@UE4 BEGIN - Changes for LWS_PLATFORM_EXTERNAL
#elif defined(LWS_PLATFORM_EXTERNAL)

#undef IMPLEMENT_FILESYSTEM
#undef IMPLEMENT_FULL_HOSTNAMERESOLVE
...
#define USE_LWS_HOSTNAMERESOLVE
#define LWS_FORMAT(fmtarg) __printflike(fmtarg, fmtarg+1)
//@UE4 END - Changes for LWS_PLATFORM_EXTERNAL
#else /* NOT WIN32 */
#include <unistd.h>
...
//@UE4 BEGIN - Changes for LWS_PLATFORM_EXTERNAL
#if defined(IMPLEMENT_FULL_HOSTNAMERESOLVE)
/**
...
#endif // #if defined(IMPLEMENT_FULL_HOSTNAMERESOLVE)
//@UE4 END - Changes for LWS_PLATFORM_EXTERNAL
