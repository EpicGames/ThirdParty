...
extern const int LWS_POLLIN;
extern const int LWS_POLLOUT;
extern const int LWS_POLLHUP;
...
#if defined(USE_LWS_HOSTNAMERESOLVE)
...
#endif //#if defined(LWS_PLATFORM_EXTERNAL)
