...
lws_client_connect_2(struct lws *wsi)
{
...
#endif
	{
		...
		struct lws_addrinfo ai, *res, *result;
#else
...
#if defined(USE_LWS_HOSTNAMERESOLVE)
		getaddrinfoResult = lws_getaddrinfo(ads, NULL, &ai, &result);
#else
		getaddrinfoResult = getaddrinfo(ads, NULL, &ai, &result);
#endif
